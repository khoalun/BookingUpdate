...
import { registerAction } from "../../actions/ManageUserAction";
import "./Register.css";
  ...
  return (
    <div>
      <Form
        ...
        style={{
          backgroundImage: `url("https://assets.nflxext.com/ffe/siteui/vlv3/0bd3a69d-6790-4edc-9818-1c8c558946c2/d2ac96f5-1ad6-4619-9bc1-ff58ad843154/FI-en-20220329-popsignuptwoweeks-perspective_alpha_website_small.jpg")`,
        }}
      ...
      >
        ...
        >
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-slate-400 py-10 px-10">
              <svg
