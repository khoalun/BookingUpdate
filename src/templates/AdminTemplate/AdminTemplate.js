...
const AdminTemplate = (props) => { //path, exact, Component
    ...
    const operations = <Fragment>
        {!_.isEmpty(userLogin) ? <Fragment> <button className='mr-5 text-blue-800' onClick={() => {
            history.push('/profile')
        }}> <img style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} 
            src='https://picsum.photos/50/50' alt='https://picsum.photos/50/50'
        className="text-2xl ml-5 rounded-full bg-red-200">
        
        </img> Hello ! {userLogin.taiKhoan}</button> 
        ...
        return <Fragment>
            ...
            <Layout style={{ minHeight: '100vh' }}>
                ...
                <Layout className="site-layout">
                    ...
                    <Footer style={{ textAlign: 'center' }}> ©2018 Created by KhoaBui</Footer>
                </Layout>
            </Layout>
        </Fragment>
    }} />
